...
const Newsletter = () => {
  ...
  return (
    <div className="z-10 bg-gradient-to-b from-primary to-purple-300 dark:to-purple-900 max-w-screen-md w-full my-12 flex gap-4 items-center flex-col rounded-md px-4 py-8 text-white ">
